          ...
          <AnimatePresence mode="wait">
            {!selectedFile ? (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="bg-accent rounded-2xl shadow-lg p-8 border-2 border-dashed border-gray-300 text-center hover:border-blue-400 hover:bg-blue-50/20 transition"
              >
              ...
              >
                {/* Header */}
                <div className="flex justify-between items-center p-6 border-b border-gray-200 bg-accent">
                  <div>
                ...
                {/* Download */}
                {processedImage && (
                  <div className="p-6 border-t border-gray-200 bg-accent">
